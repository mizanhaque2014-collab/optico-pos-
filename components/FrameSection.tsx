    ...
    <div className="bg-[#1E293B] border border-white/10 p-5 rounded-xl shadow-lg">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
        ...
        <div className="col-span-1">
          ...
          <input type="number" min="1" className="w-full bg-[#0F172A] border border-white/10 rounded-lg px-3 py-2 text-white font-bold focus:border-cyan-500 focus:outline-none" value={qty} onChange={e => setQty(Number(e.target.value))} />
        </div>
        <div className="col-span-1">
